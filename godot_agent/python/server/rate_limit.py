...
def sleep_seconds(attempt, retry_after=None):
    ...
    простою, либо к повтору раньше срока и ещё одному 429.

    Число попыток ограничено тем же бюджетом len(SLEEPS) даже с Retry-After:
    иначе провайдер, упорно отвечающий «подожди 5 секунд», держал бы агента
    в цикле бесконечно.
    """
