...
import _bootstrap  # noqa: E402,F401  # v104-restructure
...
_routes34 = open(os.path.join(_here, "server", "chat_routes.py"), encoding="utf-8").read()
...
_dsp36 = open(os.path.join(_here, "parsers", "deepseek_parser.py"), encoding="utf-8").read()
...
_dsp38 = open(os.path.join(_here, "parsers", "deepseek_parser.py"), encoding="utf-8").read()
...
_pb40 = open(os.path.join(_here, "parsers", "parser_base.py"), encoding="utf-8").read()
...
_src14 = open(os.path.join(_here, "parsers", "parser_base.py"), "r", encoding="utf-8").read()
...
_src15 = open(os.path.join(_here, "godot_tools", "project_tools.py"), "r", encoding="utf-8").read()
...
_src16 = open(os.path.join(_here, "parsers", "parser_base.py"), "r", encoding="utf-8").read()
...
_src17p = open(os.path.join(_here, "parsers", "parser_base.py"), "r", encoding="utf-8").read()
_src17m = open(os.path.join(_here, "main.py"), "r", encoding="utf-8").read()
_src17r = open(os.path.join(_here, "server", "chat_routes.py"), "r", encoding="utf-8").read()
_src17a = open(os.path.join(_here, "parsers", "ai_parser.py"), "r", encoding="utf-8").read()
_src17d = open(os.path.join(_here, "parsers", "deepseek_parser.py"), "r", encoding="utf-8").read()
...
_src18 = open(os.path.join(_here, "godot_tools", "tscn_lint.py"), "r", encoding="utf-8").read()
...
_src19 = open(os.path.join(_here, "parsers", "parser_base.py"), "r", encoding="utf-8").read()
...
_pb26_src = open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "parsers", "parser_base.py"), "r", encoding="utf-8").read()
...
_src27 = open(os.path.join(_here, "parsers", "parser_base.py"), "r", encoding="utf-8").read()
...
check("27.5 agent_prompts.py содержит правило про ===DONE===",
      "===DONE===" in open(os.path.join(_here, "server", "agent_prompts.py"), "r", encoding="utf-8").read())
